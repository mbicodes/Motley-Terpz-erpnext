...
class Analytics:
	...
	def get_sales_transactions_based_on_order_type(self):
		...
		if self.filters.get("exclude_internal"):
			qb_query = qb_query.where(doctype.customer.notin(INTERNAL_CUSTOMERS))

		self.entries = qb_query.run(as_dict=True)
	...
	def get_sales_transactions_based_on_customers_or_suppliers(self):
		...
		if self.filters.get("exclude_internal") and self.filters.tree_type == "Customer":
			filters["customer"] = ["not in", INTERNAL_CUSTOMERS]
	...
	def get_sales_transactions_based_on_customer_or_territory_group(self):
		...
		if self.filters.get("exclude_internal") and self.filters.tree_type in ["Customer Group", "Territory"]:
			filters["customer"] = ["not in", INTERNAL_CUSTOMERS]
