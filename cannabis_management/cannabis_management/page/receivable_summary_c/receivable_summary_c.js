frappe.pages["receivable-summary-c"].on_page_load = function (wrapper) {
    var page = frappe.ui.make_app_page({
        parent: wrapper,
        title: "Receivable Summary (Customer)",
        single_column: true,
    });
    ...
    page.main.html(`
        <div class="receivable-summary-container">
            <div class="receivable-summary-header">
                ...
                <div>
                    <h2 class="rs-header-title">Receivable Summary (Customer)</h2>
                    <p class="rs-header-subtitle">Accounts Receivable aging overview — Outstanding (Customers Only)</p>
                </div>
            </div>
...
function load_receivable_data(page) {
    ...
    frappe.call({
        method: "cannabis_management.cannabis_management.page.receivable_summary_c.receivable_summary_c.get_receivable_summary",
        args: {
            ...
            if (r.message && r.message.length) {
                ...
                table_area.html(`
                    <div class="rs-empty-state">
                        ...
                        <p>No outstanding Customer receivables found for the selected date.</p>
                    </div>
                `);
                cards_area.html("");
            }
