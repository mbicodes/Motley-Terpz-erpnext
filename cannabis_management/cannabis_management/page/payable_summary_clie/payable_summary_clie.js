frappe.pages["payable-summary-clie"].on_page_load = function (wrapper) {
    var page = frappe.ui.make_app_page({
        parent: wrapper,
        title: "Payable Summary (Supplier)",
        single_column: true,
    });
    ...
    page.main.html(`
        <div class="receivable-summary-container">
            <div class="receivable-summary-header">
                ...
                <div>
                    <h2 class="rs-header-title">Payable Summary (Supplier)</h2>
                    <p class="rs-header-subtitle">Accounts Payable aging overview — Outstanding (Suppliers Only)</p>
                </div>
            </div>
...
function load_payable_data(page) {
    ...
    frappe.call({
        method: "cannabis_management.cannabis_management.page.payable_summary_clie.payable_summary_clie.get_payable_summary",
        args: {
            ...
            if (r.message && r.message.length) {
                ...
                table_area.html(`
                    <div class="rs-empty-state">
                        ...
                        <p>No outstanding Supplier payables found for the selected date.</p>
                    </div>
                `);
                cards_area.html("");
            }
