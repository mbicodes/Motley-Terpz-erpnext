frappe.pages["receivable-summary"].on_page_load = function (wrapper) {
    ...
    page.main.html(`
        <div class="receivable-summary-container">
            <div class="receivable-summary-header">
                ...
                <div>
                    <h2 class="rs-header-title">Receivable Summary</h2>
                    <p class="rs-header-subtitle">Accounts Receivable aging overview — Outstanding by party</p>
                </div>
            </div>
    ...
    frappe.call({
        method: "cannabis_management.cannabis_management.page.receivable_summary.receivable_summary.get_companies",
        callback: function (r) {
...
function load_receivable_data(page) {
    ...
    frappe.call({
        method: "cannabis_management.cannabis_management.page.receivable_summary.receivable_summary.get_receivable_summary",
        args: {
            company: company,
        ...
        callback: function (r) {
            if (r.message && r.message.length) {
                render_receivable_summary(page, r.message);
            } else {
                table_area.html(`
                    <div class="rs-empty-state">
                        ...
                        <h3>No Receivable Data</h3>
                        <p>No outstanding receivables found for the selected date. Try a different report date.</p>
                    </div>
                `);
                cards_area.html("");
            }
        ...
        error: function () {
            table_area.html(`
                <div class="rs-empty-state">
                    ...
                    <p>Could not fetch receivable summary. Please check the console for details.</p>
                </div>
            `);
        },
    });
...
function render_receivable_summary(page, data) {
    let totals = {
        outstanding: 0,
        range1: 0,
        range2: 0,
