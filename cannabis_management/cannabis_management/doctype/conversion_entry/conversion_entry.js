...
function clear_hidden_fields_for_row(frm, cdt, cdn) {
	...
	if (!['2 to 1', '2 to 2', '3 to 1', '3 to 2', '3 to 3', '4 to 1', '4 to 3', '5 to 1', '6 to 1', '7 to 1'].includes(ct)) {
		frappe.model.set_value(cdt, cdn, 'raw_material_2', '');
		frappe.model.set_value(cdt, cdn, 'qty_rm_2', 0);
	}
	if (!['3 to 1', '3 to 2', '3 to 3', '4 to 1', '4 to 3', '5 to 1', '6 to 1', '7 to 1'].includes(ct)) {
		frappe.model.set_value(cdt, cdn, 'raw_material_3', '');
		frappe.model.set_value(cdt, cdn, 'qty_rm_3', 0);
	}
	if (!['4 to 1', '4 to 3', '5 to 1', '6 to 1', '7 to 1'].includes(ct)) {
	...
	if (!['1 to 2', '2 to 2', '1 to 3', '3 to 2', '3 to 3', '4 to 3'].includes(ct)) {
